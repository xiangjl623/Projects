...
(function($) {
    ...
    $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               var tipue_search_w = ' target="contentIframe"'; 
               if (set.newWindow)
               {
               ...
               {    
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {    
                                        var titleUrl = found[i].url + '?keywords='  + $('#tipue_search_input').val();   
										out += '<div class="tipue_search_content_title"><a href="' + "template.html?file=" + titleUrl + '"' + tipue_search_w + '>' +  found[i].title + '</a></div>';
                                        /*
                                        if (set.debug)
                                        {                                             
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   out += '<div id="navigation"><nav><div id="tipue_search_foot"><ul id="tipue_search_foot_boxes">';
                    ...
                    $('#tipue_search_content').hide().html(out).slideDown(500);
